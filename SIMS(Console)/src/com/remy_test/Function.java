		...
		try {
			if (file.length() >= 1) {
				...
				case "1":
					...
					System.out.println("综合成绩优秀的有" + A + "人！");
					System.out.println("综合成绩良好的有" + B + "人！");
					System.out.println("综合成绩中等的有" + C + "人！");
					System.out.println("综合成绩不及格的有" + D + "人！");
					break;
				case "2":
					for (Student s : array) {
						if (s.getScoreAvg() >= 90)
					...
					System.out.println("平均成绩优秀的有" + A + "人！");
					System.out.println("平均成绩良好的有" + B + "人！");
					System.out.println("平均成绩中等的有" + C + "人！");
					System.out.println("平均成绩不及格的有" + D + "人！");
					break;
				case "3":
					break;
				default:
